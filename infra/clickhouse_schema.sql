...
CREATE TABLE IF NOT EXISTS garuda.metrics_hourly (
    timestamp DateTime,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS garuda.metrics_mv TO garuda.metrics_hourly AS
SELECT
